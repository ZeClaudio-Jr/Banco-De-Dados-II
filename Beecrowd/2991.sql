SELECT
	...
	TO_CHAR((AVG(tsalario.salario - tdescontos.descontos)), '99999.99') AS "Media Salarial",
	TO_CHAR((MAX(tsalario.salario - tdescontos.descontos)), '99999.99') AS "Maior Salario",
	(CASE
        WHEN MIN(tsalario.salario - tdescontos.descontos) = 0  THEN '0'
        ELSE TO_CHAR((MIN(tsalario.salario - tdescontos.descontos)), '9999.99')
